[Setup]
AppName=EAXReverb
AppVerName=EAXReverb
DefaultDirName={pf}\EAXReverb
DefaultGroupName=EAXReverb
AllowNoIcons=yes
OutputBaseFilename=EAXReverb
...
Source: "EAXReverb.dll"; DestDir: {code:GetVSTDir_32}; Components: VST32
Source: "EAXReverb_X64.dll"; DestDir: {code:GetVSTDir_64}; Components: VST64; Check: Is64BitInstallMode
